    ...
    \Magento\Framework\DataObject\IdentityInterface
{
    ...
    public function __construct(
        ...
        \Techlogix\Blog\Model\Post $post,
    ...
    /**
     * @return \Techlogix\Blog\Model\Post
     */
    public function getPost()
    {
        ...
        if (!$this->hasData('post')) {
            if ($this->getPostId()) {
                /** @var \Techlogix\Blog\Model\Post $page */
    ...
    {
        return [\Techlogix\Blog\Model\Post::CACHE_TAG . '_' . $this->getPost()->getId()];
    }
