...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Techlogix_HelloWorld::employee')
            ->addBreadcrumb(__('HelloWorld'), __('HelloWorld'))
            ->addBreadcrumb(__('Manage Employees'), __('Manage Employees'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('helloworld_employee', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('HelloWorld Employees'));
