...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Techlogix_HelloWorld::save')) {
    ...
    {
        if ($this->_coreRegistry->registry('helloworld_employee')->getId()) {
            return __("Edit Employee '%1'", $this->escapeHtml($this->_coreRegistry->registry('helloworld_employee')->getTitle()));
        } else {
